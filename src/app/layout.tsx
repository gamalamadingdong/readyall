    ...
    <header className="sticky top-0 z-20 border-b border-neutral-200/80 bg-white/85 backdrop-blur dark:border-neutral-800 dark:bg-neutral-950/80">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-5 text-sm text-neutral-600 dark:text-neutral-300">
          ...
          <Link href="/community" className="hover:text-neutral-950 dark:hover:text-white">
            Community
          </Link>
    ...
    <footer className="border-t border-neutral-200 dark:border-neutral-800 py-10">
      <div className="mx-auto max-w-7xl px-6 text-center text-sm text-neutral-500">
        ...
        <div className="mt-3 flex justify-center gap-5">
          <Link href="/docs" className="hover:text-neutral-800 dark:hover:text-neutral-200">
            Docs
          </Link>
          <Link href="/community" className="hover:text-neutral-800 dark:hover:text-neutral-200">
            Community
          </Link>
          <Link href="/roadmap" className="hover:text-neutral-800 dark:hover:text-neutral-200">
            Roadmap
          </Link>
          <Link href="/feedback" className="hover:text-neutral-800 dark:hover:text-neutral-200">
            Feedback
          </Link>
          <Link href="/support" className="hover:text-neutral-800 dark:hover:text-neutral-200">
            Support
          </Link>
          <a
